...
class AuthorizationFilterTest {
    ...
    @Test
    public void doFilter_userRequestsUserSite_callsChainDoFilter() throws ServletException, IOException {
        var user = new User();
    ...
    @Test
    public void doFilter_userRequestsForbiddenSite_callsResponseSendError() throws ServletException, IOException {
        var user = new User();
        user.setRole(Role.USER);
        when(userBean.getUser()).thenReturn(user);
        when(request.getServletPath()).thenReturn("/views/admin");
